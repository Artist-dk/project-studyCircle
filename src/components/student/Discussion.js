...
const users = [
    {
      ...
      name: 'Sundar Pichai',
      status: 'online',
      imageUrl: 'url_to_sundar_pichai_image'
    },
    {
      id: 2,
      name: 'Satya Nadella',
      status: 'offline',
      imageUrl: 'url_to_satya_nadella_image'
    },
    {
      id: 3,
      name: 'Tim Cook',
      status: 'online',
      imageUrl: 'url_to_tim_cook_image'
    },
    {
      id: 4,
      name: 'Elon Musk',
      status: 'away',
      imageUrl: 'url_to_elon_musk_image'
    },
    {
      id: 5,
      name: 'Jeff Bezos',
      status: 'offline',
      imageUrl: 'url_to_jeff_bezos_image'
    },
];
...
export default function Discussion() {
    ...
    const handleClick = (user) => {
        ...
        console.log(user.id)
        // const dummyMessages = [
        //   { text: 'Hello!', time: '7:09 pm', type: 'received' },
        //   { text: 'Hi there!', time: '7:10 pm', type: 'sent' }
        // ];
        let userId = user.id;

        function handleClick(userId) {
          axios.get('http://localhost:8081/message/fetchMessages', { params: { userId } })
            .then(response => {
  ...
  return (
    <div className="chatapp">
      ...
      <div className="chat-main">
              ...
              <div className="contact-head">
                <div className="contact-head-main">
                  ...
                  <div className="details-cont">
                    ...
                    <div className="status">{selectedUser.status}</div>
                  </div>
                </div>
              </div>
        ...
        {/* Display chat messages based on selected user */}
